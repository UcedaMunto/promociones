...
/**
 * @method Acuerdo|null find($usoId , $puertoId)
 ...
 */
class UsoPuertosRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, UsoPuertos::class);
    }
